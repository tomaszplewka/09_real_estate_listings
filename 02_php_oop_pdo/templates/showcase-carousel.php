...
<div id="showcaseCarousel" class="carousel slide carousel-fade position-relative" data-ride="carousel">
    <div id="showcase-main-heading" class="position-absolute d-flex flex-column justify-content-center align-items-center">
        <h1 class="display-3 text-white py-3">Find Your Dream Home</h1>
